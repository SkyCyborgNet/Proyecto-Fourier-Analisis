...
// ================================================================
// CARGA DE DATOS (VERSIÓN MODIFICADA)
// ================================================================
...
function transformarDatos(data) {
    ...
    if (data.senales.senoidal) {
        const s = data.senales.senoidal;
        const x = s.x || [];
        // Crear un pulso rectangular (ancho 200ms, centro en 500ms)
        const y = x.map(ti => (ti >= 0.4 && ti <= 0.6) ? 1 : 0);
    ...
    // ============================================================
    // 3. ESCALÓN (simulado a partir de la senoidal)
    // ============================================================
    if (data.senales.senoidal) {
        const s = data.senales.senoidal;
        const x = s.x || [];
        const y = x.map(ti => ti >= 0.3 ? 1 : 0);
    ...
    // ============================================================
    // 4. PULSO VARIANTE (simulado a partir de la senoidal)
    // ============================================================
    if (data.senales.senoidal) {
        const s = data.senales.senoidal;
        const x = s.x || [];
    ...
    // ============================================================
    // 5. SENOIDAL AMORTIGUADA (simulado a partir de la senoidal)
    // ============================================================
    if (data.senales.senoidal) {
        const s = data.senales.senoidal;
        const x = s.x || [];
